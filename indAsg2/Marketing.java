...
//2.1 Inheritance
public class Marketing extends BowlingCentre implements TotalPayment{
	...
	public Marketing(String n, String l, String c, int pr, String d, double rf) { //constructor with two argument
		super(n, l, c);
		this.prize = pr;
		this.day = d;
